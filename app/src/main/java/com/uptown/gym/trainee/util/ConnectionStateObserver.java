...
public class ConnectionStateObserver extends LiveData<Boolean> {
    private Context mContext;
    private ConnectivityManager.NetworkCallback networkCallback = null;
    private NetworkReceiver networkReceiver;
    private ConnectivityManager connectivityManager;

    public ConnectionStateObserver(Context context) {
        mContext = context;
    ...
    class NetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public NetworkCallback(ConnectionStateObserver connectionStateObserver) {
        ...
        public void onAvailable(Network network) {
            if (network != null) {
                connectionStateObserver.postValue(true);
            }
        }

        @Override
        public void onLost(Network network) {
            connectionStateObserver.postValue(false);
        }
    }
